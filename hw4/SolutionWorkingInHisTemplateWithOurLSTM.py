...
class EncoderRNN(nn.Module):
    ...
    def forward(self, input, hidden):
        ...
        # hidden_seq = torch.cat(hidden, dim=0)
...
def train(input_tensor, target_tensor, encoder, decoder, optimizer, criterion, max_length=MAX_LENGTH):
    ...
    # encoder=optim.Adam(encoder.parameters())
    # decoder=optim.Adam(decoder.parameters())
...
def main():
    ...
    ap.add_argument('--n_iters', default=50, type=int,
                    help='total number of examples to train on')
    ap.add_argument('--print_every', default=5000, type=int,
                    help='print loss info every this many training examples')
    ap.add_argument('--checkpoint_every', default=100000, type=int,
